//Devuelve 1 si es su resolucion mayor o igual a 1024 sino retorna cero
...
function muestraReloj()
 ...
 function cambia(num){
	switch(num)
	{
		case 1:
			{
			document.getElementById('contenido').style.backgroundImage = "url(a_1/1.jpg)";
		...
		case 2:
			document.getElementById('contenido').style.backgroundImage = "url(a_1/2.jpg)";
			...
			break;
		case 3:
			document.getElementById('contenido').style.backgroundImage = "url(a_1/3.jpg)";
			...
			break;
		case 4:
			document.getElementById('contenido').style.backgroundImage = "url(a_1/4.png)";
			document.getElementById('flotante').innerHTML = "<br /><br />Tienda Proyecto BD";			
			document.getElementById('contenido').innerHTML = " ";
			break;
		case 5:
			document.getElementById('contenido').style.backgroundImage = "url(a_1/4.jpg)";
