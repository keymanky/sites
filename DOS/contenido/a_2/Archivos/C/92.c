...
int N; //N contiene el tamano de la matriz cuadrada
...
do{
printf("\n JORGE SALGADO MENDOZA \n METODOS NUMERICOS 2254\n\n      CALCULANDO LA INVERSA Ingrese el tamano de la matriz cuadrada:\n");
/*para calcular la inversa tuve que transformar en funciones los otros codigos para tener mas facilmente la inversa*/

scanf("%i",&N);
if(N>50 || N<2)  {printf("\nEl numero debe estar entre 2 y 50n");}
}while(N>50 || N<2);
...
for(co=0;co<N;co++)
{
printf("\nIngrese el valor de matriz[%i][%i]",fi+1,co+1);
